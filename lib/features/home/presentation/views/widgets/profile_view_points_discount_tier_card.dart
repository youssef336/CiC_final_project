    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
          color: isUnlocked
              ? KprimaryColorLight
              : (isDark ? KdarkModeTextSecondary.withOpacity(0.35) : Colors.grey[300]!),
          width: 2,
        ),
        boxShadow: [
          BoxShadow(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isUnlocked
                      ? KprimaryColor
                      : (isDark ? KdarkModeTextSecondary.withOpacity(0.25) : Colors.grey[300]),
                  ...
                  children: [
                    Text(
                      ...
                      style: AppTextStyles.cairoBold.copyWith(
                        ...
                        color: isUnlocked
                            ? KprimaryColor
                            : (isDark ? KdarkModeTextColor : Colors.grey[700]),
                      ),
                    ),
                    ...
                    Text(
                      ...
                      style: AppTextStyles.bodySmallRegular.copyWith(
                        color: isUnlocked
                            ...
                            : (isDark ? KdarkModeTextSecondary : Colors.grey[600]),
                        fontSize: 13,
                      ),
                    ),
                  ],
                  ...
                  children: [
                    Text(
                      ...
                      style: AppTextStyles.bodySmallSemibold.copyWith(
                        color: isDark ? KdarkModeTextSecondary : Colors.grey[700],
                        fontSize: 12,
                      ),
                    ),
                    Text(
